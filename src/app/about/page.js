            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  To provide accessible, affordable, and quality education opportunities to students across India. We
                  bridge the gap between students and their dream institutions through personalized counseling and
